    ...
    return (
        <swiper-container className="swiper-container">
            <swiper-slide>
                ...
                <img data-bs-toggle="popover" data-bs-trigger="hover focus" title="Compasso.UOL" data-bs-content="Estágio em AWS Cloud Engineering. Estudo as principais tecnologias do mercado de Data Analytics e participo de projetos digitais." data-bs-placement="bottom" src={require('./project-pictures/LogoCompasso-positivo.png')}></img>
                <img data-bs-toggle="popover" data-bs-trigger="hover focus" title="KNN Idiomas" data-bs-content="Fui instrutor de inglês por 1 ano, desenvolvendo minhas habilidades de comunicação e didática" data-bs-placement="bottom" style={{width: "45%"}} src={require('./project-pictures/knn-logo-1.png')}></img>
